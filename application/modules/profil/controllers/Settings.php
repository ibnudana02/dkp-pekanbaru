...
{
    protected $permissionCreate = 'Profil.Settings.Create';
    protected $permissionDelete = 'Profil.Settings.Delete';
    protected $permissionEdit   = 'Profil.Settings.Edit';
    protected $permissionView   = 'Profil.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_profil()) {
                ...
                redirect(SITE_AREA . '/settings/profil');
            }
