...
{
    protected $permissionCreate = 'Profil.Reports.Create';
    protected $permissionDelete = 'Profil.Reports.Delete';
    protected $permissionEdit   = 'Profil.Reports.Edit';
    protected $permissionView   = 'Profil.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_profil()) {
                ...
                redirect(SITE_AREA . '/reports/profil');
            }
