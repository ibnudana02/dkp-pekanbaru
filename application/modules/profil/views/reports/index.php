...
$num_columns	= 3;
$can_delete	= $this->auth->has_permission('Profil.Reports.Delete');
$can_edit		= $this->auth->has_permission('Profil.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/profil/edit/' . $record->id_profil, '<span class="icon-pencil"></span> ' .  $record->judul_profil); ?></td>
				<?php else : ?>
