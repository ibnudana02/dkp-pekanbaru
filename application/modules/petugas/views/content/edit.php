            ...
            <div class="control-group<?php echo form_error('kecamatan') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                   <select name="kecamatan">
                    ...
                    <option value="<?= $kc ?>" <?php echo set_value('kecamatan', ($petugas->kecamatan == $kc) ? 'selected' : ''); ?>><?= $kc ?></option>
                    <?php } ?>
                    </select>
            ...
            <div class="control-group">
                ...
                <div class='controls'>
                    ...
                    <option disabled selected>Pilih salah satu</option>
                     ...
                     <option value="<?= $usr->id ?>" <?php echo set_value('id_user', ($petugas->id_user == $usr->id) ? 'selected' : ''); ?> ><?= $usr->username." (".$usr->display_name.")" ?></option>
                     <?php } ?>
                    </select>
