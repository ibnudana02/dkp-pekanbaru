...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('Petugas.Developer.Delete');
$can_edit		= $this->auth->has_permission('Petugas.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/petugas/edit/' . $record->id_petugas, '<span class="icon-pencil"></span> ' .  $record->nama_petugas); ?></td>
				<?php else : ?>
