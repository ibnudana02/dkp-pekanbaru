...
{
    protected $permissionCreate = 'Pengangkutan_sampah.Settings.Create';
    protected $permissionDelete = 'Pengangkutan_sampah.Settings.Delete';
    protected $permissionEdit   = 'Pengangkutan_sampah.Settings.Edit';
    protected $permissionView   = 'Pengangkutan_sampah.Settings.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/settings/pengangkutan_sampah/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_pengangkutan_sampah()) {
                ...
                redirect(SITE_AREA . '/settings/pengangkutan_sampah');
            }
