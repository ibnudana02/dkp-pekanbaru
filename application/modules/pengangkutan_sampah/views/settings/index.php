...
$num_columns	= 4;
$can_delete	= $this->auth->has_permission('Pengangkutan_Sampah.Settings.Delete');
$can_edit		= $this->auth->has_permission('Pengangkutan_Sampah.Settings.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/settings/pengangkutan_sampah/edit/' . $record->id_laporan, '<span class="icon-pencil"></span> ' .  $record->id_user); ?></td>
				<?php else : ?>
