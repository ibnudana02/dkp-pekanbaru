...
{
    protected $permissionCreate = 'Rute.Content.Create';
    protected $permissionDelete = 'Rute.Content.Delete';
    protected $permissionEdit   = 'Rute.Content.Edit';
    protected $permissionView   = 'Rute.Content.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_rute()) {
                ...
                redirect(SITE_AREA . '/content/rute');
            }
