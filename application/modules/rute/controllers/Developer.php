...
{
    protected $permissionCreate = 'Rute.Developer.Create';
    protected $permissionDelete = 'Rute.Developer.Delete';
    protected $permissionEdit   = 'Rute.Developer.Edit';
    protected $permissionView   = 'Rute.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_rute()) {
                ...
                redirect(SITE_AREA . '/developer/rute');
            }
