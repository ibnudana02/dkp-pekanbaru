...
{
    protected $permissionCreate = 'Rute.Reports.Create';
    protected $permissionDelete = 'Rute.Reports.Delete';
    protected $permissionEdit   = 'Rute.Reports.Edit';
    protected $permissionView   = 'Rute.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_rute()) {
                ...
                redirect(SITE_AREA . '/reports/rute');
            }
