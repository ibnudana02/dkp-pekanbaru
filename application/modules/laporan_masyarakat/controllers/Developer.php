...
{
    protected $permissionCreate = 'Laporan_masyarakat.Developer.Create';
    protected $permissionDelete = 'Laporan_masyarakat.Developer.Delete';
    protected $permissionEdit   = 'Laporan_masyarakat.Developer.Edit';
    protected $permissionView   = 'Laporan_masyarakat.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_laporan_masyarakat()) {
                ...
                redirect(SITE_AREA . '/developer/laporan_masyarakat');
            }
