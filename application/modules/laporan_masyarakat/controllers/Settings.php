...
{
    protected $permissionCreate = 'Laporan_masyarakat.Settings.Create';
    protected $permissionDelete = 'Laporan_masyarakat.Settings.Delete';
    protected $permissionEdit   = 'Laporan_masyarakat.Settings.Edit';
    protected $permissionView   = 'Laporan_masyarakat.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_laporan_masyarakat()) {
                ...
                redirect(SITE_AREA . '/settings/laporan_masyarakat');
            }
