...
<div class='admin-box'>
    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        ...
        <fieldset class='form-actions'>
            ...
            <?php echo lang('bf_or'); ?>
            <?php echo anchor(SITE_AREA . '/content/laporan_masyarakat', lang('laporan_masyarakat_cancel'), 'class="btn btn-warning"'); ?>
            
            <?php if ($this->auth->has_permission('Laporan_Masyarakat.Content.Delete')) : ?>
                <?php echo lang('bf_or'); ?>
