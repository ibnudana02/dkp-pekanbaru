...
var marker1 = L.Marker.movingMarker([[0.5186,101.4472],[0.5192,101.4466]], 10000);
...
var ruteLines = L.geoJson(null, {
		...
		onEachFeature: function (feature, layer) {
			if (feature.properties) {
				...
				layer.on({
					click: function (e) {
                        //marker1 = L.Marker.movingMarker(geoBalik(feature.geometry.coordinates[0]), 20000)
                        ...
                        marker1.start();
                        console.log(geoBalik(feature.geometry.coordinates[0]));
...
var map = new L.Map('map', {
		...
		minZoom: 3,
        center: [0.54, 101.5],
        layers: [layer, ruteLines, marker1]
	});
