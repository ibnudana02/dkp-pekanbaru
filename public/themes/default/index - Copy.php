...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="assets/imgages/favicon-76.png">
  ...
  <body>
        ...
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="data/kelurahan.php" download="kelurahan.geojson" target="_blank" data-toggle="collapse" data-target=".navbar-collapse.in"><i class="fa fa-download"></i>&nbsp;&nbsp;Kelurahan</a></li>
                  <li><a href="data/jalan_arteri.php" download="jalan_arteri.geojson" target="_blank" data-toggle="collapse" data-target=".navbar-collapse.in"><i class="fa fa-download"></i>&nbsp;&nbsp;Jalan Arteri</a></li>
                  <!--
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Selamat datang di Kota Pekanbaru</h4>
          </div>
          <div class="modal-body">
            <ul class="nav nav-tabs nav-justified" id="aboutTabs">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="#boroughs-tab" data-toggle="tab">Kelurahan</a></li>
                  <li><a href="#subway-lines-tab" data-toggle="tab">Jalan Arteri</a></li>
	...
	<!-- DIV berikut untuk menampilkan keterangan fitur saat diklik-->
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">
			  <!-- ini ditampilkan saat diklik, sila lihat app.js-->
			  DKP Pekanbaru
            </h4>
          </div>
          <div class="modal-body">
            <div id="attribution">
              Developed by Eka Wulandari based on <a href='http://bryanmcbride.com'>Bootleaf</a>
			</div>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
